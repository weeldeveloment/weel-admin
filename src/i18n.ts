  ...
  en: {
    translation: {
      ...
      nav: {
        ...
        banners: 'Banners',
        chat: 'Chat',
        b2bSupport: 'B2B Support',
        b2bOwnership: 'Ownership requests',
      ...
      b2bSupport: {
        title: 'B2B Support',
        subtitle: 'Questions employees sent from the WEEL B2B app',
        searchPlaceholder: 'Employee, company or phone...',
        empty: 'Nobody has written in yet',
        noneSelected: 'Pick a conversation on the left',
        threadEmpty: 'No messages in this conversation',
      ...
      b2bOwnership: {
        ...
        subtitle: 'A workspace owner asking to hand the company to someone else, or to close it',
        empty: 'Nothing waiting on a decision',
        loadFailed: 'Could not load the requests',
        kind: {
        ...
        confirmApprove: {
          ...
          transferDescription: "The owner role on '{{company}}' moves to {{target}} immediately.",
          closeDescription: "'{{company}}' and every workspace under it closes immediately.",
        },
        confirmReject: {
          title: 'Reject this request?',
          description: "Nothing changes on '{{company}}' — the owner can ask again.",
        },
        actionFailed: 'Could not save the decision. Try again.',
      },
      b2b: {
        title: 'B2B Accounts',
      ...
      inspection: {
        ...
        beds: {
          ...
          quantity: 'Quantity',
          remove: 'Remove bed',
          required: 'Please select at least one bed type.',
        },
        bedTypes: {
          single: 'Single Bed',
          twin: 'Twin Bed',
        ...
        current: 'Current',
        'dialog.title': 'Room {{room}}',
        'dialog.condition': 'Set condition',
        'dialog.save': 'Save',
        ...
        create: {
          action: 'Add Room',
          title: 'Add Room',
          description: 'Create a room in this hotel inventory.',
          selectRoomType: 'Select room type',
          submit: 'Create Room',
          creating: 'Creating...',
          noRoomTypes: 'Add an active room type first.',
        },
        roomType: {
          action: 'Add Room Type',
          title: 'New Room Type',
          subtitle: 'Create an active room type to enable room creation.',
          name: 'Name',
          preset: 'Preset',
          capacity: 'Capacity',
          baseRate: 'Base Rate',
          description: 'Description',
          submit: 'Create Room Type',
          creating: 'Creating...',
        },
        tabs: {
          details: 'Details',
  ...
  ru: {
    translation: {
      ...
      nav: {
        ...
        banners: 'Баннеры',
        chat: 'Чат',
        b2bSupport: 'B2B поддержка',
        b2bOwnership: 'Заявки на владение',
      ...
      b2bSupport: {
        title: 'B2B поддержка',
        subtitle: 'Вопросы сотрудников из приложения WEEL B2B',
        searchPlaceholder: 'Сотрудник, компания или телефон...',
        empty: 'Пока никто не написал',
        noneSelected: 'Выберите переписку слева',
      ...
      b2bOwnership: {
        ...
        subtitle: 'Владелец компании просит передать компанию другому человеку или закрыть её',
        empty: 'Нет заявок, ожидающих решения',
        loadFailed: 'Не удалось загрузить заявки',
        kind: {
          transfer: 'Передача владения',
          close: 'Закрытие компании',
        },
        requestedBy: 'Запросил',
        target: 'Новый владелец',
        reason: 'Причина',
        ...
        notePlaceholder: 'Заметка для истории (необязательно)',
        confirmApprove: {
          title: 'Одобрить эту заявку?',
          transferDescription: 'Роль владельца в «{{company}}» немедленно перейдёт к {{target}}.',
          closeDescription: '«{{company}}» и все её рабочие пространства закроются немедленно.',
        },
        confirmReject: {
          title: 'Отклонить эту заявку?',
          description: 'В «{{company}}» ничего не изменится — владелец может подать заявку снова.',
        },
        actionFailed: 'Не удалось сохранить решение. Попробуйте ещё раз.',
      },
      b2b: {
        title: 'B2B аккаунты',
      ...
      inspection: {
        title: 'Осмотр номеров',
        'filter.search': 'Поиск номера...',
        'filter.condition': 'Состояние',
        'filter.floor': 'Этаж',
        'filter.all': 'Все',
        'filter.allFloors': 'Все этажи',
        'condition.clean': 'Чистый',
        'condition.dirty': 'Грязный',
        'condition.inspection': 'Осмотр',
        'condition.maintenance': 'Ремонт',
        'availability.available': 'Доступен',
        'availability.occupied': 'Занят',
        'availability.blocked': 'Заблокирован',
        beds: {
          title: 'Кровати',
          add: 'Добавить кровать',
          type: 'Тип кровати',
          quantity: 'Количество',
          remove: 'Удалить кровать',
          required: 'Пожалуйста, выберите хотя бы один тип кровати.',
        },
        bedTypes: {
          single: 'Односпальная кровать',
          twin: 'Двуспальная кровать',
          double: 'Двойная кровать',
          king: 'Кровать King-size',
          sofa: 'Кровать-диван',
          bunk: 'Двухъярусная кровать',
          kids: 'Детская кровать',
          extra: 'Дополнительная кровать',
        },
        'card.floor': 'Этаж',
        'card.type': 'Тип',
        'card.availability': 'Доступность',
        'card.capacity': 'Вместимость',
        current: 'Текущий',
        'dialog.title': 'Номер {{room}}',
        'dialog.condition': 'Установить состояние',
        'dialog.save': 'Сохранить',
        'dialog.cancel': 'Отмена',
        'dialog.saving': 'Сохранение...',
        empty: 'Номера не найдены.',
        floor: 'Этаж {{number}}',
        create: {
          action: 'Добавить номер',
          title: 'Добавить номер',
          description: 'Создайте номер в инвентаре этого отеля.',
          selectRoomType: 'Выберите тип номера',
          submit: 'Создать номер',
          creating: 'Создание...',
          noRoomTypes: 'Сначала добавьте активный тип номера.',
        },
        roomType: {
          action: 'Добавить тип номера',
          title: 'Новый тип номера',
          subtitle: 'Создайте активный тип номера, чтобы включить создание номеров.',
          name: 'Название',
          preset: 'Пресет',
          capacity: 'Вместимость',
          baseRate: 'Базовая ставка',
          description: 'Описание',
          submit: 'Создать тип номера',
          creating: 'Создание...',
        },
        tabs: {
          details: 'Детали',
        ...
        images: {
          ...
          remove: 'Удалить',
          empty: 'Фотографии не загружены.',
          uploading: 'Загрузка...',
        },
        bookings: {
          title: 'История бронирований',
          empty: 'Нет бронирований для этого номера.',
          guest: 'Гость',
          checkIn: 'Заезд',
          checkOut: 'Выезд',
          status: 'Статус',
  ...
  uz: {
    translation: {
      ...
      nav: {
        ...
        banners: 'Bannerlar',
        chat: 'Chat',
        b2bSupport: 'B2B yordam',
        b2bOwnership: 'Egalik so’rovlari',
      ...
      b2bSupport: {
        title: 'B2B yordam markazi',
        subtitle: 'WEEL B2B ilovasidan kelgan xodimlar savollari',
        searchPlaceholder: 'Xodim, kompaniya yoki telefon...',
        empty: 'Hali hech kim yozmagan',
        noneSelected: 'Chapdan suhbatni tanlang',
        threadEmpty: 'Bu suhbatda xabar yo\u2019q',
        replyPlaceholder: 'Javob yozing...',
        send: 'Yuborish',
        sending: 'Yuborilmoqda...',
        waiting: 'kutmoqda',
        loadFailed: 'Suhbatni yuklab bo\u2019lmadi',
      },
      b2bOwnership: {
        title: 'Egalik so\u2019rovlari',
        subtitle: 'Kompaniya egasi kompaniyani boshqa odamga topshirish yoki uni yopishni so\u2019ramoqda',
        empty: 'Hozircha qaror kutayotgan so\u2019rov yo\u2019q',
        loadFailed: 'So\u2019rovlar yuklanmadi',
        kind: {
          transfer: 'Egalikni topshirish',
          close: 'Kompaniyani yopish',
        },
        ...
        confirmApprove: {
          title: 'Ushbu so\u2019rov tasdiqlansinmi?',
          transferDescription: '\u2018{{company}}\u2019dagi egalik roli darhol {{target}}ga o\u2019tadi.',
          closeDescription: '\u2018{{company}}\u2019 va uning barcha ish joylari darhol yopiladi.',
        },
        confirmReject: {
          title: 'Ushbu so\u2019rov rad etilsinmi?',
          description: '\u2018{{company}}\u2019da hech narsa o\u2019zgarmaydi \u2014 egasi qayta so\u2019rov yubora oladi.',
        },
        actionFailed: 'Qaror saqlanmadi. Qayta urinib ko\u2019ring.',
      },
      b2b: {
      ...
      inspection: {
        title: 'Xonalarni tekshirish',
        'filter.search': 'Xona qidirish...',
        'filter.condition': 'Holat',
        'filter.floor': 'Qavat',
        'filter.all': 'Barchasi',
        'filter.allFloors': 'Barcha qavatlar',
        'condition.clean': 'Toza',
        'condition.dirty': 'Kir',
        'condition.inspection': 'Tekshiruv',
        'condition.maintenance': "Ta'mirlash",
        'availability.available': 'Mavjud',
        'availability.occupied': 'Band',
        'availability.blocked': 'Bloklangan',
        beds: {
          title: 'Karavotlar',
          add: "Karavot qo'shish",
          type: 'Karavot turi',
          quantity: 'Soni',
          remove: 'Karavotni olib tashlash',
          required: 'Kamida bitta karavot turini tanlang.',
        },
        bedTypes: {
          single: 'Bir kishilik karavot',
          twin: 'Ikki kishilik karavot',
          double: 'Dubl karavot',
          king: 'King-size karavot',
          sofa: 'Divan-karavot',
          bunk: 'Ikki qavatli karavot',
          kids: 'Bolalar karavoti',
          extra: "Qo'shimcha karavot",
        },
        'card.floor': 'Qavat',
        'card.type': "Turi",
        'card.availability': 'Mavjudligi',
        'card.capacity': 'Sig"imi',
        current: 'Joriy',
        'dialog.title': 'Xona {{room}}',
        'dialog.condition': 'Holatni belgilash',
        'dialog.save': 'Saqlash',
        'dialog.cancel': 'Bekor qilish',
        'dialog.saving': 'Saqlanmoqda...',
        empty: 'Xonalar topilmadi.',
        floor: '{{number}}-qavat',
        create: {
          action: 'Xona qo‘shish',
          title: 'Xona qo‘shish',
          description: 'Mehmonxona inventariga yangi xona yarating.',
          selectRoomType: 'Xona turini tanlang',
          submit: 'Xona yaratish',
          creating: 'Yaratilmoqda...',
          noRoomTypes: 'Avval faol xona turini qo‘shing.',
        },
        roomType: {
          action: 'Xona turi qo‘shish',
          title: 'Yangi xona turi',
          subtitle: 'Xona yaratish mumkin bo‘lishi uchun faol xona turini yarating.',
          name: 'Nomi',
          preset: 'Preset',
          capacity: 'Sig‘imi',
          baseRate: 'Asosiy narx',
          description: 'Tavsif',
          submit: 'Xona turini yaratish',
          creating: 'Yaratilmoqda...',
        },
        tabs: {
          details: "Tafsilotlar",
        ...
        images: {
          add: 'Rasm qo‘shish',
          cover: 'Muqova',
          setCover: 'Muqova qilib belgilash',
          remove: 'O‘chirish',
          empty: 'Rasmlar yuklanmagan.',
          uploading: 'Yuklanmoqda...',
        },
        bookings: {
          title: 'Buyurtmalar tarixi',
          empty: 'Bu xona uchun buyurtmalar yo‘q.',
          guest: 'Mehmon',
          checkIn: 'Kirish',
          checkOut: 'Chiqish',
          status: 'Holat',
          bookingNumber: 'Buyurtma #',
        },
      },
    },
  },
